...
def fetch_iss_crew_names():
    try:
        api_logs.info("Api request: {}: Url: {}".format("Function fetch_iss_crew_names", ASTRONAUTS_IN_SPACE_URL))
        result = requests.get(ASTRONAUTS_IN_SPACE_URL)
        result.raise_for_status()
    except requests.exceptions.HTTPError as e:
        status_code = result.status_code
        api_errors.error(("status code: {},error: {}, Api request: {}: Url: {}" .format(status_code, e, "Function fetch_iss_crew_names", ASTRONAUTS_IN_SPACE_URL)))
        api_logs.error(("status code: {},error: {}, Api request: {}: Url: {}".format(status_code, e,
                                                                                       "Function fetch_iss_crew_names",
        ...
        api_logs.info(
            "Api response: {}: Url: {}, result: {}".format("Function fetch_iss_crew_names", ASTRONAUTS_IN_SPACE_URL,
                                                           result.json()))
        return result
